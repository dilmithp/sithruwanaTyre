...
<head>
    ...
    <title>Sithruwana Tyre Mart - Login</title>
    <!-- Tailwind CSS -->
...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="px-8 py-6 mt-4 text-left bg-white shadow-lg border-t-4 border-blue-600 rounded-lg">
        ...
        <h3 class="text-2xl font-bold text-center text-gray-800 mb-6">Login to Sithruwana Tyre Mart</h3>
        ...
        <% if(request.getAttribute("registrationSuccess") != null) { %>
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
                <span class="block sm:inline"><%= request.getAttribute("registrationSuccess") %></span>
            </div>
        <% } %>
